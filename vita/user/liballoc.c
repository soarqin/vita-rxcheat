...
#define ALIGN_TYPE		char ///unsigned char[4] /// unsigned short
...
void *PREFIX(malloc)(size_t req_size) {
    ...
    req_size = (req_size + ALIGNMENT - 1) & ~(ALIGNMENT - 1);
