...
strings:
  ...
  NEXT_SEARCH: Next
  NEW_FUZZY: New fuzzy search
  LESS_FUZZY: VALUE-
  GREATER_FUZZY: VALUE+
  CANCEL_FUZZY: Abandon fuzzy search
  VALUE: "Value:"
  HEX: HEX
  HEAP: HEAP
  SEARCHING: Searching
  ...
  TROPHY_NAME: Name
  TROPHY_GRADE: Grade
  TROPHY_HIDDEN: Hidden
  TROPHY_UNLOCKED: Unlocked
  TROPHY_TITLE_HIDDEN: "Hidden##%d"
  YES: YES
  NO: NO
  TROPHY_UNLOCK: Unlock
  TROPHY_UNLOCK_ALL: Unlock All
  POPUP_EDIT: Edit memory
